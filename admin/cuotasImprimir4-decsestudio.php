<?php
	...
	//Talon 1
		...
		//NumeSoli
		$pdf->Text(18, 39, utf8_decode('Nº de Cuenta'));
		...
		//NumeCuot
		$pdf->Text(58, 39, utf8_decode('Período'));
		...
		//ValoMovi
		$pdf->Text(141, 58, utf8_decode('Empresa'));
